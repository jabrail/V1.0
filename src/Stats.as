...
public class Stats extends Sprite {
		...
		public function Stats() : void {
			...
			xml = <xml><mode>Mode:</mode><fps>FPS:</fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax></xml>;
			...
			style.setStyle('mode', {color: hex2css(colors.memmax)});
		...
		private function init(e : Event) : void {
			...
			graph = new BitmapData(WIDTH, HEIGHT - 55, false, colors.bg);
			graphics.beginBitmapFill(graph, new Matrix(1, 0, 0, 1, 0, 55));
			graphics.drawRect(0, 55, WIDTH, HEIGHT - 55);
